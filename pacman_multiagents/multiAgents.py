...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState: GameState, action):
        ...
        return successorGameState.getScore() + (10 / (minFoodDistance + 1))
...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def minimax(self, gameState, depth, agentIndex):
        ...
        if agentIndex == 0:
            ...
            for action in gameState.getLegalActions(agentIndex):
                successor = gameState.generateSuccessor(agentIndex, action)
                value = min(value, self.minimax(successor, depth, nextAgent))
    ...
    def alphabeta(self, gameState, depth, agentIndex, alpha, beta):
        ...
        if agentIndex == 0:
            ...
            for action in gameState.getLegalActions(agentIndex):
                ...
                value = max(
                    value,
                    self.alphabeta(successor, depth, 1, alpha, beta)
                )
            ...
            for action in gameState.getLegalActions(agentIndex):
                ...
                value = min(
                    value,
                    self.alphabeta(successor, depth, nextAgent, alpha, beta)
                )
    ...
    def expectimax(self, gameState, depth, agentIndex):
        ...
        if agentIndex == 0:
            ...
            for action in actions:
                ...
                total += self.expectimax(successor, depth, nextAgent)
